...
The hero acts as an eye-catcher for your site. So consider to give him a nice background. You just need to replace the [`uncertain.gif`](//github.com/digitalcraftsman/hugo-agency-theme/blob/master/static/img/uncertain.gif) at [`static/img`](//github.com/digitalcraftsman/hugo-agency-theme/tree/master/static/img) with your own background image. But it's important that you keep the original filename.
